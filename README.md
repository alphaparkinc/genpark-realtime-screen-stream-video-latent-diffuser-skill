# genpark-realtime-screen-stream-video-latent-diffuser-skill
...
> **GenPark AI Agent Skill** -- Sub-50ms screen stream live latent video diffuser (Krea Realtime style)
